...
public class ShoppingListDisplayAdaptor extends RecyclerView.Adapter<ShoppingListDisplayAdaptor.shoppingListDisplayAdaptor_ViewHolder>{
    ...
    @Override
    public void onBindViewHolder(@NonNull shoppingListDisplayAdaptor_ViewHolder holder, int position) {
        Log.i("testing",itemList.get(position));
        Log.i("testing",itemList.get(position).toString());
